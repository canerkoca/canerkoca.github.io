window['___jsl'] = window['___jsl'] || {};(window['___jsl']['ci'] = (window['___jsl']['ci'] || [])).push({"rpc":{"passReferrer":"p2c:query","parentRelayUrl":"/rpc_relay.html"}});window['___jsl']=window['___jsl']||{};(window['___jsl']['ci'] = (window['___jsl']['ci'] || [])).push({"rpc":{"passReferrer":"p2c:query","parentRelayUrl":"/rpc_relay.html"}});
...
/* [end] feature=rpc */
gadgets.config.init({"rpc":{"passReferrer":"p2c:query","parentRelayUrl":"/rpc_relay.html"}});
