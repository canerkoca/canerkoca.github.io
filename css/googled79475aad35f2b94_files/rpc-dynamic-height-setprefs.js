...
(function(){var j=window['___jsl']=window['___jsl']||{};j['l']=(j['l']||[]).concat(['rpc','dynamic-height','setprefs']);})();(function() {var nm='libLoaded';if (typeof window[nm]==='function') {window[nm]();}})();(function(){var j=window['___jsl']=window['___jsl']||{};if(j['c']){j['c']();delete j['c'];}})();